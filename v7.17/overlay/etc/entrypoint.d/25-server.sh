...
declare -x ELASTICSEARCH_CLUSTER_INITIAL_MASTER_NODES
[[ -z "${ELASTICSEARCH_CLUSTER_INITIAL_MASTER_NODES}" ]] && ELASTICSEARCH_CLUSTER_INITIAL_MASTER_NODES=""

declare -x ELASTICSEARCH_NODE_NAME
[[ -z "${ELASTICSEARCH_NODE_NAME}" ]] && ELASTICSEARCH_NODE_NAME="${HOSTNAME}"

declare -x ELASTICSEARCH_NODE_ROLES
[[ -z "${ELASTICSEARCH_NODE_ROLES}" ]] && ELASTICSEARCH_NODE_ROLES="master,data,ingest"
...
declare -x ELASTICSEARCH_DISCOVERY_TYPE
[[ -z "${ELASTICSEARCH_DISCOVERY_TYPE}" ]] && ELASTICSEARCH_DISCOVERY_TYPE=""

declare -x ELASTICSEARCH_DISCOVERY_SEED_HOSTS
[[ -z "${ELASTICSEARCH_DISCOVERY_SEED_HOSTS}" ]] && ELASTICSEARCH_DISCOVERY_SEED_HOSTS=""
